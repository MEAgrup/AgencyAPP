...
check "tabel public"     "select count(*) from information_schema.tables where table_schema='public' and table_type='BASE TABLE'" "77"
...
# 34 = 17 (v1) + 14 (v2, O55) + 2 (v3, M5-OA-7) + 1 (v4, A-08 sanggahan target). Angka ini TIDAK boleh dinaikkan sendirian: ia
