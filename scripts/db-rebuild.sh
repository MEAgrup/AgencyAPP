...
check "tabel public"     "select count(*) from information_schema.tables where table_schema='public' and table_type='BASE TABLE'" "90"
check "entity_prefix"    "select count(*) from entity_prefix"    "31"
check "sm_machines"      "select count(*) from sm_machines"      "18"
