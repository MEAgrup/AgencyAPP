...
# produksi fungsi SECURITY DEFINER-nya bisa dipanggil `anon`. Persis yang
# terjadi pada wrr_monday_job / wrr_reminder_tick / penugasan_reminder_tick —
# ditemukan hanya karena seseorang membaca `proacl` live (DECISIONS 2026-08-14).
#
