-- Port dari backend/migrations/0020_account_am_assignment.up.sql (MySQL) — konversi per docs/SUPABASE_MIGRATION_TECH_APPENDIX.md §A
--
...
-- later M6 cluster).
ALTER TABLE clients
    ADD COLUMN assigned_am_id varchar(64) NULL;

CREATE INDEX idx_clients_assigned_am ON clients (assigned_am_id);
