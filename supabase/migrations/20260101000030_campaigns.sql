-- Port dari backend/migrations/0030_campaigns.up.sql (MySQL) — konversi per docs/SUPABASE_MIGRATION_TECH_APPENDIX.md §A
--
...
CREATE TABLE campaigns (
    ...
    is_online         boolean      NOT NULL DEFAULT false, -- Online/Offline checklist (multi-select)
...
CREATE INDEX idx_cmp_owner ON campaigns (owner_employee_id);
CREATE INDEX idx_cmp_status ON campaigns (status);
