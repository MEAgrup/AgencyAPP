...
// --- M13 Client Health: mirror the Go module13_health JSON tags ---

/** module13_health.Component — one scored/excluded component (excluded_reason omitempty). */
...
/** module13_health.Snapshot — a stored snapshot or a live preview (computed_at/by omitempty). */
...
export function healthSnapshotToWire(s: health.Snapshot): HealthSnapshotWire {
  return {
    ...
    components: s.components.map(healthComponentToWire),
...
/** module13_health.RoasToggle — the ROAS Inclusion Toggle read view (Rule 13). */
...
/** module13_health.ScanResult — one snapshot-sweep tally. */
