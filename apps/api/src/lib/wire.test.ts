...
describe('M4 clientDetailToWire (O41 #1 — the Client Record contract)', () => {
  const detail: sales.ClientDetail = {
    ...
    platforms: [
      { clientPlatformId: 1, platform: 'Shopee', storeLink: 'https://shopee/alpha', managedSince: new Date('2026-05-01T00:00:00.000Z'), active: true, tahapFokus: 'awareness', shopId: 'SHOP-001' },
      { clientPlatformId: 2, platform: 'TikTok Shop', storeLink: null, managedSince: null, active: false, tahapFokus: null, shopId: null },
    ],
  ...
  it('maps to the snake_case shape web-internal declares, money as IDR strings', () => {
    expect(clientDetailToWire(detail)).toEqual({
      ...
      platforms: [
        { client_platform_id: 1, platform: 'Shopee', store_link: 'https://shopee/alpha', managed_since: '2026-05-01', active: true, tahap_fokus: 'awareness', shop_id: 'SHOP-001' },
        { client_platform_id: 2, platform: 'TikTok Shop', store_link: undefined, managed_since: null, active: false, tahap_fokus: null, shop_id: null },
      ],
