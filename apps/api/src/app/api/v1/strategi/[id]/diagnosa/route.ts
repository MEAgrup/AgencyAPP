 ...
 *   - diagnosa      (C-1/C-2/C-3/C-4): per-channel bottleneck + reason + root cause + gap
 ...
 * state a non-empty free-text `alasan`. An empty one returns 422 so the AM can
 * fix it immediately rather than encountering it at submit.
 *
