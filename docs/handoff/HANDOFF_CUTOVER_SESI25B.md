# HANDOFF — Cutover Sesi 25**B** (butir 6 gate GO: backup MySQL Railway + OQ-2)

> ⚠️ **DUA SESI 25 BERJALAN PARALEL.** `HANDOFF_CUTOVER_SESI25.md` (PR #87,
> ter-merge lebih dulu) menutup **C-03 + O50 + draft rollback**. Berkas ini
> (PR #86) menutup **butir 6 gate GO: backup MySQL Railway + OQ-2**. Keduanya
> nol tumpang tindih kode — yang satu dokumen + keputusan, yang satu skrip +
> workflow. Preseden penamaan: SESI16A/SESI16B.
>
> **Kalau keduanya berbeda soal C-03, yang berlaku adalah SESI25 (PR #87)** —
> ia yang memindahkan SKIP-2 ke C-04 dan menutup C-03 `[x]`.
