...
- **Status R-03/R-04 (2026-08-30): lapisan domain SELESAI & diuji; route API, wire mapper, FE lib, dan tombol/form UI `/clients/[id]` BELUM dibangun** — lihat `docs/backlog/SALESPERF_BACKLOG.md` §Stream B.
