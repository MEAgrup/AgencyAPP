...
**Handoff eksekusi:** `docs/handoff/HANDOFF_ADVERTISER_TOOLS_SESI6_20260903.md` (baca yang bernomor tertinggi lebih dulu — rantai: `…UI_20260903` → `…SC08_20260903` → `…G2G3G4_20260903` → `…SESI5_20260903` → `…SESI6_20260903`)
