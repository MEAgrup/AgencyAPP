...
## Tiket untuk sesi `mcnapp` (M3-A)

Sesi terpisah — `add_repo` lintas-owner ditolak dari sesi CDPS. Kontrak + fixture sudah disiapkan
sesi M3-B, tinggal disalin identik:
...
`M3-01-REGION` (Hans), `M3-02-PRICE-SEGMENT-VALUES` (Hans), `M3-03-KATEGORI-MAPPING` (Hans),
`M3-05-PUSH-TRIGGER` (Hans, M3-A), `M3-08-SENGKETA-90-HARI` (Nerissa). `M3-04`
