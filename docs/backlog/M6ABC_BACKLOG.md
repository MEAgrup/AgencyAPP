...
| **A-13b** | **Sisa form: Section A, B, C, E, F + UI revisi (A-12)** | Baris navigasinya SUDAH ada dan tetap menampilkan hitungan kekurangannya — seksi yang belum bisa dibuka tetap harus terhitung, kalau tidak total di tombol Ajukan tidak menjumlah dan AM tidak punya cara menjelaskan selisihnya. Section B paling besar (±45 field × channel). ⚠️ `saveStrategiNarasi` mengganti KEEMPAT field E-1/E-13/H-3/H-4 sekaligus — Section E harus mengirim ulang H-3/H-4 apa adanya, persis seperti Section H hari ini mengirim ulang E-1/E-13 |
