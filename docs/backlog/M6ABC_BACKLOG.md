...
| ~~**A-09b**~~ | ~~Sisa Section E/F/G/H/I~~ | ✅ **SELESAI 2026-08-08** — migrasi `20260808040000_m6a_section_efghi`. Lima tabel anak (`strategi_ketergantungan_klien` E-12 · `strategi_fase` G-1 · `strategi_tanggal_besar` G-2 · `strategi_trigger_revisi` H-2 · `strategi_dispatch` I-2+I-4), kolom header G-3/G-4/I-3, dan E-2 di `strategi_channel`. Gerbang tabel **76 → 81**. Empat route: `/ketergantungan` `/kalender` `/trigger-revisi` `/handoff`. 24 test baru. **Yang lebih besar dari tiketnya:** H-2 memberi Rule 13 daftar yang selama ini tidak ada, jadi `strategi_version.trigger_revisi` (J-3) yang sejak A-03 menerima string APA PUN sekarang terikat set yang SAMA (`ck_strver_trigger_set`), plus subset per-Strategi di domain. **E-4 floor price** tetap seperti sebelumnya: kolomnya sudah ada (`strategi_pillar.floor_price`); yang belum adalah validasi Brief yang MEMBACANYA — tiket M7/M12, bukan M6A. Pertanyaan terbuka baru: **X-14** (enum I-3) dan **O60** (detektor ledger O48). Lihat DECISIONS 2026-08-08 |
