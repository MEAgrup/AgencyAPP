...
## Gelombang 2 — Report engine Shopee (paritas penuh)
...
## Gelombang 3 — MEA SKU Screener (Modul A, B, C, D)
...
| SC-08 | UI `web-internal/src/app/(shell)/ads/screening/` — unggah → tabel rute → tempel ke Decision Log/Tracker |

Catatan: hasil screening **tidak** mengisi RM-C — screening bukan realisasi, ia alat keputusan.

---

## Gelombang 4 (menyusul) — TikTok Ads Scanner
