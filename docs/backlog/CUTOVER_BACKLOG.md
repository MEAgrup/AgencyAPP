...
>    remote menolak pembuatan tag (`send-pack: unexpected disconnect`, 8 percobaan, annotated dan
>    lightweight sama-sama gagal; remote nol tag). Tag ADA secara lokal. Karena butir ini
