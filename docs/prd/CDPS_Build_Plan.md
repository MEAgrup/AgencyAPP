...
| 20 | `CDPS_Module20_PDT_Laporan_Klien.md` | **New — added 2026-09-22** (permukaan laporan klien PDT: renderer HTML `klien`/`internal`, revisi insight + publikasi, portal klien, penulis `clients.total_sales`/Health Score/baseline Ads untuk PDT Rule 24, plus bagian Tokopedia & TikTok Ads Manager). Ini **port M14 → PDT**, bukan fitur baru — lahir dari audit pemilik "report klien vs PDT, fitur serupa tapi double" (`docs/DECISIONS.md` Open `M14-VS-PDT-DUPLIKASI`). Rencana eksekusi: `docs/plan/PLAN_PORT_M14_KE_PDT.md`. **Status 2026-09-22 sore: Gelombang A/B/C merge (PR #494/#496/#497); migrasi C-01 sudah di live (malam 2026-09-22); Gelombang D berikutnya, nol blocker dengan bentuk direvisi — GANTI SUMBER halaman Laporan portal, bukan tambah halaman (R11 "klien melihat tepat satu laporan"; R11.3 ketokan pemilik: hanya `[Terbit]`, satu periode = versi terbaru, kontrak 3 bulan = 3 laporan berbeda periode).** |
