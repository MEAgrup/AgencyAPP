 ...
 * - pilarkatalog: katalog aksi pilar Section E (4 pilar × 20 aksi) yang
 *   disajikan editor pilar manual. Bekas `copilot`; mesin aturannya dicabut
 *   bersama pensiunnya AM Co-Pilot (DECISIONS 2026-09-21 PENSIUN-AMTOOLS) ✅
...
export * as pilarkatalog from './pilarkatalog';
