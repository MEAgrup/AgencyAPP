...
describeDb('financeQueue', () => {
  it('lists only [Menunggu Verifikasi], with derived amounts and the schedule', async () => {
  ...
  it('drops a transaction once it leaves the queue, and tracks partial amounts', async () => {
